            ...
            <div class="card-content">
                <div class="card-header">
                    <div class="header-icon">
                        @if(strtolower($profile->judul) == 'kepala sekolah')
                            <i class="fas fa-user-tie"></i>
                        @elseif(strtolower(trim($profile->judul)) == 'smkn 4 bogor')
                        ...
                        <div class="kepsek-profile">
                            <div class="kepsek-image-container">
                                <div class="image-frame">
                                    <img src="{{ asset('assets/images/kepsek.jpg') }}" alt="Kepala Sekolah">
                                </div>
                    ...
                    @elseif(strtolower(trim($profile->judul)) == 'smkn 4 bogor')
                        <div class="school-profile">
                            <div class="school-logo">
                                <img src="{{ asset('assets/images/logo smk.png') }}" alt="SMKN 4 Bogor">
                            </div>

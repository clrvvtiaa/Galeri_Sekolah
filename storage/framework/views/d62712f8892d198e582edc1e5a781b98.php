...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('agenda.store')); ?>" method="POST">
        ...
        <div class="form-group mb-3">
            ...
            <input type="date" class="form-control" name="agenda_date" id="agenda_date" value="<?php echo e(old('agenda_date')); ?>" required>
        </div>

        <button type="submit" class="btn btn-primary">Simpan Agenda</button>
    </form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ukk_sulistia\resources\views/admin/agenda/create.blade.php ENDPATH**/ ?>
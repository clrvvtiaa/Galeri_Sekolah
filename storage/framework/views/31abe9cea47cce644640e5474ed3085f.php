            ...
            <div class="slides">
                <?php if(isset($sliders)): ?>
                    <?php $__empty_1 = true; $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="slide">
                            <img src="<?php echo e(asset('storage/'.$slider->image)); ?>" alt="<?php echo e($slider->alt_text); ?>">
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="slide">
                            <img src="<?php echo e(asset('assets/images/default.jpg')); ?>" alt="Default Image">
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
        ...
        <div class="row min-vh-100 align-items-center">
            <div class="d-flex justify-content-center align-items-center text-white">
                <div class="text-center">
                    <?php if(isset($kontens) && $kontens->isNotEmpty()): ?>
                        <?php $__currentLoopData = $kontens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $konten): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <h1 class="display-4 fw-bold custom-font text-shadow"><?php echo e($konten->judul); ?></h1>
                            <p class="lead mb-4 custom-font text-shadow"><?php echo e($konten->subjudul); ?></p>
...
<div class="container py-5">
    <div class="row g-4">
        ...
        <!-- Baris Pertama -->
        <div class="col-md-6">
            <a href="<?php echo e(route('jurusans.public')); ?>" class="text-decoration-none">
        ...
        <div class="col-md-6">
            <a href="<?php echo e(route('galeri')); ?>" class="text-decoration-none">
        ...
        <!-- Baris Kedua -->
        <div class="col-md-6">
            <a href="<?php echo e(route('agenda')); ?>" class="text-decoration-none">
        ...
        <div class="col-md-6">
            <a href="<?php echo e(route('informasi')); ?>" class="text-decoration-none">
...
<!-- Map Section -->
<?php if($map = App\Models\Map::first()): ?>
<div id="peta" class="bg-light py-5">
    <div class="container">
        <h2 class="text-center mb-4"><?php echo e($map->title ?? 'Lokasi Kami'); ?></h2>
        <div class="row">
            <div class="col-12">
                <div class="map-container shadow-sm rounded">
                    <iframe 
                        src="<?php echo e($map->embed_url); ?>"
                        width="100%" 
                        height="450" 
                        style="border:0;" 
                        allowfullscreen="" 
                ...
                <div class="text-center mt-3">
                    <a href="<?php echo e($map->google_maps_link); ?>" 
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ukk_sulistia\resources\views/home.blade.php ENDPATH**/ ?>
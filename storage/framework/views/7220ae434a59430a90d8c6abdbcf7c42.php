...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - SMKN 4 Bogor</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        ...
        <div class="border-top mt-3 pt-2">
            <p class="text-center text-muted mb-0">
                <small>&copy; <?php echo e(date('Y')); ?> SMK Negeri 4 Bogor_Sulistia Maharani Syafitri. All rights reserved.</small>
            </p>
        </div>
    </div>
</footer>
...
<?php /**PATH C:\ukk_sulistia\resources\views/layouts/main.blade.php ENDPATH**/ ?>
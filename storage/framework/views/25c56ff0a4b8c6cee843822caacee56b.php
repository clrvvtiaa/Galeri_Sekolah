<aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.konten-beranda.index')); ?>" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('profiles.index')); ?>" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.sliders.index')); ?>" aria-expanded="false">
                                <i data-feather="film" class="feather-icon"></i><span class="hide-menu">Slider</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('map.index')); ?>" aria-expanded="false">
            ...
            <!-- End Sidebar scroll-->
        </aside><?php /**PATH C:\ukk_sulistia\resources\views/admin/partials/_sidebar.blade.php ENDPATH**/ ?>
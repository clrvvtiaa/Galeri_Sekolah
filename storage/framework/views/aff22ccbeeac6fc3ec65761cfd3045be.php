...
<?php $__env->startSection('title', 'Tambah Categories'); ?> <!-- Menetapkan title halaman -->
        ...
        <form action="/categories" method="POST" class="needs-validation" novalidate>
            ...
            <div class="form-group row">
                <div class="col-md-9 offset-md-3">
                    ...
                    <a href="<?php echo e(url('/petugas')); ?>" class="btn btn-secondary">Batal</a>
                </div>
            </div>
        </form>
    </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ukk_sulistia\resources\views/admin/categories/create.blade.php ENDPATH**/ ?>